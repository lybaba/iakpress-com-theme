  ...
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <nav class="hidden md:flex space-x-1">
        <a href="/xpressui/" class="<?php echo is_page('xpressui') || is_front_page() ? $nav_active : $nav_idle; ?>">Product</a>
        ...
        <a href="/fr/" class="<?php echo trim( (string) parse_url( $_SERVER['REQUEST_URI'] ?? '', PHP_URL_PATH ), '/' ) === 'fr' ? $nav_active : $nav_idle; ?>">FR</a>
      </nav>
      ...
      <div class="flex items-center space-x-4">
        ...
        <a href="/contact/" class="hidden md:inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-bold rounded-lg text-white bg-blue-600 hover:bg-blue-700 shadow-sm transition">
          Try live intake
        </a>
        <!-- Mobile Menu (simplified) -->
        <div class="md:hidden flex items-center">
          <a href="/contact/" class="text-blue-600 font-bold text-sm mr-4">Try intake</a>
