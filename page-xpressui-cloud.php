...
<div class="font-sans text-gray-900 antialiased">
    ...
    <div class="max-w-5xl mx-auto text-center">
      ...
      <div class="flex flex-col sm:flex-row justify-center gap-4">
        ...
        <a href="<?php echo esc_url($pricing_url); ?>" class="bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-800 font-bold py-4 px-8 rounded-lg transition">
          Compare with WordPress Bridge Pro
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="bg-white py-20 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
      ...
      <h2 class="text-3xl font-bold text-gray-900 mb-10 text-center">WordPress Bridge Pro remains the fast path. XPressUI Cloud is the managed path.</h2>
      <div class="rounded-2xl border border-gray-100 overflow-hidden bg-white shadow-sm">
        <div class="grid bg-gray-50 border-b border-gray-100" style="grid-template-columns:160px 1fr 1fr">
          ...
          <div class="py-3 px-4 text-xs font-bold text-gray-500 border-l border-gray-100 uppercase tracking-wider">WordPress Bridge Pro</div>
  ...
  <section class="bg-gray-900 py-20 px-4 sm:px-6 lg:px-8 text-center">
    <div class="max-w-3xl mx-auto">
      ...
      <h2 class="text-3xl md:text-4xl font-extrabold text-white mb-4">Use XPressUI Cloud when the workflow needs shared operations, not another WordPress admin.</h2>
