  ...
  <section class="bg-gray-900 py-20 px-4 sm:px-6 lg:px-8 text-center">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="flex flex-col sm:flex-row justify-center gap-4">
        ...
        <a href="<?php echo esc_url(home_url('/fr/agency-pilot/')); ?>" class="bg-white/10 border border-white/20 hover:bg-white/20 text-white font-bold py-4 px-8 rounded-lg transition">Voir l'accompagnement</a>
      </div>
    </div>
  </section>
