...
<footer class="bg-gray-900 py-12 border-t border-gray-800 mt-auto">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center gap-6">
    <div class="w-full rounded-3xl border border-gray-800 bg-gray-950/60 p-6 md:p-8 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-5 items-center text-left">
      <div>
        <p class="text-xs font-bold tracking-widest text-blue-300 uppercase mb-2">First intake portal</p>
        <h2 class="text-2xl font-extrabold text-white mb-2">Want one client intake live before choosing the full path?</h2>
        <p class="text-sm text-gray-400 leading-relaxed">Start with a small paid pilot: private link, guided upload, operator inbox, reusable catalog surface, or client-site delivery.</p>
      </div>
