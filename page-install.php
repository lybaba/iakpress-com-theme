...
$install_copy = $is_french_install ? [
  ...
  'assisted_body' => 'Envoyez le workflow, les fichiers ou le parcours actuel, et l’endroit où le résultat doit être livré. Nous cadrons le chemin le plus rapide : lien hébergé d’abord, ou livraison sur site client quand le workflow doit vivre sur un site existant.',
  ...
  'message_3' => '<strong class="text-gray-900">1 exemple :</strong> parcours existant, tableur, capture ou document.',
...
$pro_steps = $is_french_install ? [
  ...
  [
    ...
    'body'   => 'Collez le shortcode sur n’importe quelle page de votre site en utilisant le slug de votre workflow.',
    'code'   => '[xpressui id="votre-slug-workflow"]',
    'note'   => 'Optionnel : ajoutez redirect="https://votresite.com/merci/" pour rediriger après soumission.',
  ],
] : [
  [
    'number' => '01',
  ...
  [
    ...
    'body'   => 'Paste the shortcode on any page of your site using the slug from your workflow.',
    'code'   => '[xpressui id="your-workflow-slug"]',
    'note'   => 'Optional: add redirect="https://yoursite.com/thank-you/" to redirect after submission.',
  ],
];
