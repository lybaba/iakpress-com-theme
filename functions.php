...
function iakpress_translate_french_output( string $html ): string {
    $translations = array(
        ...
        'XPressUI Cloud · Solo, Team, Agency' => 'XPressUI Cloud · Solo, Team, Agency',
        'Host the workflow link, catalogs, inbox, files, and review operations with XPressUI.' => 'Hébergez le lien du workflow, les catalogues, l’inbox, les fichiers et la revue avec XPressUI.',
        'XPressUI Cloud is for teams that want structured intake, reusable catalogs, and operator review without running the operations layer on client sites.' => 'XPressUI Cloud s’adresse aux équipes qui veulent un intake structuré, des catalogues réutilisables et une revue opérateur sans gérer la couche opérationnelle sur les sites clients.',
        'XPressUI hosts the public link and centralizes submissions, products, services, dates, files, quotas, and review in Console.' => 'XPressUI héberge le lien public et centralise les soumissions, produits, services, dates, fichiers, quotas et revues dans la Console.',
        ...
        'What XPressUI Cloud includes' => 'Ce que XPressUI Cloud inclut',
        ...
        'XPressUI Pro remains the fast path. XPressUI Cloud is the managed path.' => 'XPressUI Pro reste le chemin rapide. XPressUI Cloud est le chemin managé.',
        'Decision' => 'Décision',
        ...
        'Live intake page with XPressUI in under 10 minutes.' => 'Une page d’intake XPressUI en ligne en moins de 10 minutes.',
        ...
        'Use XPressUI Free' => 'Utiliser XPressUI Free',
        'Sell client-site delivery' => 'Vendre une livraison sur site client',
        'Discuss XPressUI delivery' => 'Discuter d’une livraison XPressUI',
        ...
        'You want XPressUI to host the public link, submissions, files, catalogs, quotas, and operator review.' => 'Vous voulez que XPressUI héberge le lien public, les soumissions, les fichiers, les catalogues, les quotas et la revue opérateur.',
        ...
        'Ask XPressUI to host links, catalogs, files, inbox, quotas, and review.' => 'Demander à XPressUI d’héberger les liens, catalogues, fichiers, inbox, quotas et revues.',
        ...
        'XPressUI client-site plugin' => 'Plugin XPressUI côté site client',
        ...
        'Starter offer · up to 5 client sites · updates included' => 'Offre Starter · jusqu’à 5 sites clients · mises à jour incluses',
        'Everything in XPressUI Free' => 'Tout ce qui est dans XPressUI Free',
        ...
        'Let XPressUI run hosted operations' => 'Laisser XPressUI gérer les opérations hébergées',
        ...
        '/month' => '/mois',
        'Solo from €19/month · Team and Agency available' => 'Solo à partir de 19 €/mois · Team et Agency disponibles',
        ...
        'Solo is enough to validate one real workflow. Team adds shared operations and basic AI assistance. Agency is the path for repeatable client delivery, white-label rollout, and higher-volume work.' => 'Solo suffit pour valider un vrai workflow. Team ajoute les opérations partagées et une première assistance IA. Agency est le chemin pour une livraison client répétable, le white-label et les volumes plus élevés.',
        ...
        'Start with XPressUI Free if you only need the bundled portal. Upgrade to XPressUI Pro for client-site delivery, or choose XPressUI Cloud when the hosted operations layer should live in Console.' => 'Commencez avec XPressUI Free si vous avez seulement besoin du portail inclus. Passez à XPressUI Pro pour la livraison sur site client, ou choisissez XPressUI Cloud quand la couche d’opérations hébergées doit vivre dans la Console.',
        'Feature' => 'Fonctionnalité',
        'Start with XPressUI Free' => 'Commencer avec XPressUI Free',
        ...
        'License valid on up to 5 client sites' => 'Licence valide jusqu’à 5 sites clients',
        'Cloud Solo limits' => 'Limites Cloud Solo',
        ...
        'Can I start with XPressUI Free first?' => 'Puis-je commencer avec XPressUI Free ?',
        'Yes. XPressUI Free is the easiest way to try the document portal experience on your own client site. You can install the bundled starter, upload custom workflow ZIPs, test the intake flow, and only upgrade when you need advanced fields, Console Sync, or workflow customization.' => 'Oui. XPressUI Free est le moyen le plus simple de tester l’expérience du portail documentaire sur votre propre site client. Vous pouvez installer le starter inclus, uploader des ZIP de workflow personnalisés, tester le flux d’intake, puis passer à la suite seulement quand vous avez besoin de champs avancés, Console Sync ou personnalisation de workflow.',
        'What does XPressUI Pro unlock exactly?' => 'Qu’est-ce que XPressUI Pro débloque exactement ?',
        'XPressUI Pro adds Customize Workflow (edit labels, choice labels, colors, messages, and validation rules per workflow directly from the client-site admin), Console Sync, specialized runtime features, automatic updates, and the license for up to 5 client sites.' => 'XPressUI Pro ajoute Customize Workflow (édition des libellés, choix, couleurs, messages et règles de validation par workflow directement depuis l’admin du site client), Console Sync, des fonctions runtime spécialisées, les mises à jour automatiques et une licence jusqu’à 5 sites clients.',
        'Where do dynamic catalogs fit?' => 'À quoi servent les catalogues dynamiques ?',
        'Catalogs are the strongest Cloud feature: products, prices, service slots, dates, and member lists can be reused across workflows instead of being hardcoded into static request pages. XPressUI Pro can integrate Cloud catalogs when needed, but product catalogs are not exported as portable PHP.' => 'Les catalogues sont l’un des points forts de Cloud : produits, prix, créneaux, dates et listes de membres peuvent être réutilisés entre workflows au lieu d’être codés en dur dans des pages de demande statiques. XPressUI Pro peut intégrer les catalogues Cloud si nécessaire, mais les catalogues produit ne sont pas exportés en PHP portable.',
        ...
        'XPressUI Pro is built for accounting firms and agencies that need repeatable client document intake with less back-and-forth.' => 'XPressUI Pro est conçu pour les cabinets comptables et agences qui ont besoin d’un intake documentaire client répétable avec moins d’allers-retours.',
        'Do you offer a larger agency plan?' => 'Proposez-vous un plan agence plus large ?',
        'Yes. Larger teams can move toward XPressUI Cloud, higher quotas, team workspace access, and managed rollout. The current Starter offer is the fastest client-site path today.' => 'Oui. Les équipes plus larges peuvent évoluer vers XPressUI Cloud, des quotas plus élevés, l’accès workspace en équipe et un déploiement managé. L’offre Starter actuelle reste le chemin site client le plus rapide aujourd’hui.',
        'Can I use it on client sites?' => 'Puis-je l’utiliser sur des sites clients ?',
        'Yes. The Pro license covers up to 5 client sites, which makes it practical for client delivery and internal use.' => 'Oui. La licence Pro couvre jusqu’à 5 sites clients, ce qui la rend adaptée à la livraison client et à l’usage interne.',
        ...
        'Use XPressUI Free today. Upgrade when your team needs repeatable intake at speed.' => 'Utilisez XPressUI Free aujourd’hui. Passez à la suite quand votre équipe a besoin d’un intake répétable et rapide.',
        'If you just want to test the experience, start free. If you want to build custom client portals you can reuse and sell, Pro is the right move.' => 'Si vous voulez simplement tester l’expérience, commencez gratuitement. Si vous voulez créer des portails clients personnalisés que vous pouvez réutiliser et vendre, Pro est le bon choix.',
        'Direct Pro sales are temporarily paused while XPressUI Free is being validated by WordPress.org.' => 'Les ventes directes Pro sont temporairement en pause pendant la validation de XPressUI Free par WordPress.org.',
        ...
        'No client-site dependency, XPressUI-managed operations' => 'Aucune dépendance au site client, opérations gérées par XPressUI',
        ...
        'Validate one hosted workflow with real users.' => 'Valider un workflow hébergé avec de vrais utilisateurs.',
        'Run shared operations with several workflows and operators.' => 'Piloter des opérations partagées avec plusieurs workflows et opérateurs.',
        'Turn workflows into a repeatable client delivery offer.' => 'Transformer les workflows en offre de livraison client répétable.',
        ...
        'We are opening Solo, Team, and Agency plans case by case for teams with active intake workflows, file-heavy submissions, reusable catalogs, or multi-operator review needs.' => 'Nous ouvrons les plans Solo, Team et Agency au cas par cas pour les équipes avec workflows d’intake actifs, soumissions riches en fichiers, catalogues réutilisables ou besoins de revue multi-opérateurs.',
        ...
        'XPressUI gives agencies and service teams one delivery system for private intake links, document upload, dynamic choices, and operator review. Use it on client WordPress sites or host the workflow with XPressUI Cloud.' => 'XPressUI donne aux agences et équipes de service un système de livraison unique pour liens privés d’intake, upload de documents, choix dynamiques et revue opérateur. Utilisez-le sur des sites WordPress clients ou hébergez le workflow avec XPressUI Cloud.',
        ...
        'XPressUI is easiest to sell when the buyer already feels the pain: missing files, outdated lists, unclear requests, or schedule changes.' => 'XPressUI se vend plus facilement quand l’acheteur ressent déjà la douleur : fichiers manquants, listes obsolètes, demandes floues ou changements de planning.',
        ...
        'We install XPressUI Pro, configure the workflow, test submissions, and hand it over with a short walkthrough.' => 'Nous installons XPressUI Pro, configurons le workflow, testons les soumissions et livrons avec une courte prise en main.',
        ...
        'Most onboarding starts badly: missing files, vague briefs, and too many follow-up emails. XPressUI replaces that chaos with a clear portal your client can actually complete in one sitting.' => 'La plupart des onboardings commencent mal : fichiers manquants, briefs vagues et trop d’emails de relance. XPressUI remplace ce chaos par un portail clair que votre client peut réellement compléter en une fois.',
        ...
        'Install XPressUI Free' => 'Installer XPressUI Free',
        'Download XPressUI Free and activate it on your site in a few minutes.' => 'Téléchargez XPressUI Free et activez-le sur votre site en quelques minutes.',
        ...
        'Why it stands out' => 'Pourquoi XPressUI se démarque',
        'Built for intake, not scattered follow-up.' => 'Conçu pour l’intake, pas pour des relances dispersées.',
        'XPressUI is aimed at the full client intake path: the private link, the guided upload, the submission status, and the operator review screen.' => 'XPressUI couvre le chemin complet d’intake client : lien privé, upload guidé, statut de soumission et écran de revue opérateur.',
        ...
        'Start with XPressUI Pro now. Move to hosted when operations need to scale.' => 'Commencez avec XPressUI Pro maintenant. Passez à l’hébergé quand les opérations doivent monter en charge.',
        'Launch quickly with XPressUI Free, upgrade to XPressUI Pro for production client-site delivery, then add XPressUI Cloud when you want XPressUI to manage links, inbox, files, quotas, and team review.' => 'Lancez vite avec XPressUI Free, passez à XPressUI Pro pour la livraison de production sur site client, puis ajoutez XPressUI Cloud quand vous voulez que XPressUI gère liens, inbox, fichiers, quotas et revue équipe.',
        ...
        'Start with XPressUI Free' => 'Commencer avec XPressUI Free',
        'Let XPressUI host the workflow and operations inbox' => 'Laisser XPressUI héberger le workflow et l’inbox opérationnelle',
        ...
        'What is XPressUI?' => 'Qu’est-ce que XPressUI ?',
        'XPressUI is a client intake portal system: private links, guided document upload, dynamic choices, and operator review in one delivery path.' => 'XPressUI est un système de portail d’intake client : liens privés, upload documentaire guidé, choix dynamiques et revue opérateur dans un même chemin de livraison.',
        'Can I start for free?' => 'Puis-je commencer gratuitement ?',
        'Yes. XPressUI Free includes the client-site runtime, a bundled document intake workflow, and custom workflow ZIP installation so you can test the setup on a real site.' => 'Oui. XPressUI Free inclut le runtime côté site client, un workflow d’intake documentaire inclus et l’installation de workflows ZIP personnalisés pour tester sur un vrai site.',
        'What is XPressUI Pro?' => 'Qu’est-ce que XPressUI Pro ?',
        'XPressUI Pro is the fastest path to production today: plugin install, workflow setup, and submission review directly in the client-site admin.' => 'XPressUI Pro est aujourd’hui le chemin le plus rapide vers la production : installation du plugin, configuration du workflow et revue des soumissions directement dans l’admin du site client.',
        'What is XPressUI Cloud?' => 'Qu’est-ce que XPressUI Cloud ?',
        'XPressUI Cloud is the next delivery path for teams that want XPressUI to host the public workflow link, submissions inbox, files, catalogs, and operator review outside a client site. Solo starts at €19/month, Team at €49/month, and Agency at €129/month.' => 'XPressUI Cloud est le chemin suivant pour les équipes qui veulent que XPressUI héberge le lien public du workflow, l’inbox de soumissions, les fichiers, catalogues et revue opérateur hors du site client. Solo commence à 19 €/mois, Team à 49 €/mois et Agency à 129 €/mois.',
        'When should I get Pro?' => 'Quand passer à Pro ?',
