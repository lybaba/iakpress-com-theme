...
function iakpress_translate_french_output( string $html ): string {
    $translations = array(
        ...
        'Starter plan: €99/year · per site · 30-day money-back guarantee' => 'Plan Starter : 99 €/an · par site · garantie satisfait ou remboursé de 30 jours',
        ...
        'per year per site.' => 'par an et par site.',
        '€99/year:' => '99 €/an :',
